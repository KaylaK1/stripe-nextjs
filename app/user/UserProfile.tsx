...
export default function UserProfile() {
    ...
    useEffect(() => {
        ...
        // Listen to auth events in supabase and run the callback function
        // on change.  Returns a realtime listener.
        // This only manages authentication state in this component. 
